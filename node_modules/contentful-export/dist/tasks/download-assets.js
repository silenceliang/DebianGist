...
function downloadAsset(url, directory) {
  return new _bluebird.default(function (resolve, reject) {
    ...
    const localFile = _path.default.join(directory, urlParts[urlParts.length - 1]); // ensure directory exists and create file stream


    _fsExtra.default.mkdirsSync(_path.default.dirname(localFile));

    const file = _fsExtra.default.createWriteStream(localFile); // handle urls without protocol
